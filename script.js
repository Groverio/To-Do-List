...
function updateTodoList() {
  try {
    ...
    console.error('Error updating the todo list:', error);
...
function setDefaultDateTime() {
  try {
    ...
    console.error('Error setting default date and time:', error);
  }
}
...
function sortTodos(sortBy) {
  try {
    ...
    alert('An error occurred while sorting the tasks. Please try again.');
  }
}
...
function filterTodos() {
  try {
    ...
    alert('An error occurred while filtering the tasks. Please try again.');
  }
}

// Initially set default date and time on load
setDefaultDateTime();
updateTodoList();
